...
class Reconstructor3D:
    ...
    def build_dae_model(self, dae_model_dir):
        ...
        # This checkpoint is a pickled nn.Module, not a state dict, so the
        # weights_only=True default introduced in torch 2.6 cannot load it.
        dae = torch.load(dae_checkpoint, weights_only=False)
